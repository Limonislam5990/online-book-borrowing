    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-amber-50/30 p-8 rounded-2xl border border-amber-100 shadow-sm space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="btn btn-block bg-orange-600 hover:bg-orange-700 text-white font-bold uppercase tracking-wider border-none rounded-xl mt-2">
            Register
          </button>
        </form>
        ...
        <p className="text-center text-xs sm:text-sm text-slate-600 pt-2">
          ...
          <Link href="/signin" className="text-orange-600 font-bold hover:underline">
            Login
          </Link>
        </p>
